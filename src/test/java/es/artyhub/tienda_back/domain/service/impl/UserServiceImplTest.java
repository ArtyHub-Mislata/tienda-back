...
class UserServiceImplTest {
    ...
    class FindAllUsers {
        ...
        void whileUsersExist_ShouldReturnListOfUsers() {
            ...
            List<UserDto> users = List.of(
                new UserDto(1L, "name1", "email1", "password1", "1111111111111111", "description1", "address1", "imageProfileUrl1", UserRole.ADMIN),
                new UserDto(2L, "name2", "email2", "password2", "2222222222222222", "description2", "address2", "imageProfileUrl2", UserRole.ADMIN),
                new UserDto(3L, "name3", "email3", "password3", "3333333333333333", "description3", "address3", "imageProfileUrl3", UserRole.ADMIN)
            );
    ...
    class FindUserById {
        ...
        void whileUserExists_ShouldReturnUser() {
            ...
            when(userRepository.findById(id)).thenReturn(Optional.of(new UserDto(id, "name", "email", "password", "1111111111111111", "description", "address", "imageProfileUrl", UserRole.ADMIN)));
    ...
    class CreateUser {
        ...
        void whileUserIsValid_ShouldCreateUser() {
            UserDto userDto = new UserDto(1L, "name", "email", "password", "1111111111111111", "description", "address", "imageProfileUrl", UserRole.ADMIN);
    ...
    class UpdateUser {
        ...
        void whileUserExists_ShouldUpdateUser() {
            UserDto userDto = new UserDto(1L, "name", "email", "password", "1111111111111111", "description", "address", "imageProfileUrl", UserRole.ADMIN);
            UserDto userDtoUpdated = new UserDto(1L, "updatedName", "updatedEmail", "password", "1111111111111111", "description", "address", "imageProfileUrl", UserRole.ADMIN);
