package es.artyhub.tienda_back.persistence;
...
import es.artyhub.tienda_back.persistence.dao.jpa.impl.CartJpaDaoImpl;
...
import es.artyhub.tienda_back.persistence.repository.impl.CartRepositoryImpl;
...
@Configuration
@EnableJpaRepositories(basePackages = "es.artyhub.tienda_back.persistence.dao.jpa")
@EntityScan(basePackages = "es.artyhub.tienda_back.persistence.dao.jpa.entity")
public class TestConfig {
    
    //BEANS DE ARTWORK
    @Bean
    public ArtworkJpaDao artworkJpaDao(EntityManager entityManager){
    ...
    //BEANS DE SESION
    @Bean
    public SesionJpaDao sesionJpaDao(EntityManager entityManager){
    ...
    //BEANS DE LOGIN
    @Bean
    public LoginJpaDao loginJpaDao(UserJpaDao userJpaDao, SesionJpaDao sesionJpaDao, EntityManager entityManager){
    ...
    //BEANS DEL CARRO
    @Bean
    public CartJpaDao cartJpaDao(EntityManager entityManager){
