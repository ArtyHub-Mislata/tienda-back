...
import es.artyhub.tienda_back.persistence.dao.jpa.impl.PaymentJpaDaoImpl;
...
import es.artyhub.tienda_back.persistence.repository.impl.PaymentRepositoryImpl;
...
public class SpringConfig {
    ...
    //BEANS DE PAYMENT
    @Bean
    public PaymentJpaDao paymentJpaDao(){
        return new PaymentJpaDaoImpl();
    }
    @Bean
    public PaymentRepository paymentRepository(PaymentJpaDao paymentJpaDao){
        return new PaymentRepositoryImpl(paymentJpaDao);
    }
    @Bean
